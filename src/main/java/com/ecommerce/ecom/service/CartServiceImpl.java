...
public class CartServiceImpl implements CartService {
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        ...
        CartItem cartItem = cartItemRepository.findCartItemByPorductIdAndCartId(
                cart.getCartId(),
                productId
        );
        if(cartItem != null) {
        ...
        if(product.getQuantity() < quantity) {
            throw new APIException("Quantity more than " +  product.getQuantity() + " cannot be fulfilled");
        }
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        CartItem cartItem = cartItemRepository.findCartItemByPorductIdAndCartId(cartId, productId);
